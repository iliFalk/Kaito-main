...
export const Icon = ({ name, className }) => {
  const icons = {
    ...
    Cog6ToothIcon: (props) => (
      React.createElement('svg', {...props, xmlns:"/vendor/svg-b0568748", fill:"none", viewBox:"0 0 24 24", strokeWidth:"1.5", stroke:"currentColor"}, 
    ...
    CheckCircleIcon: (props) => (
      React.createElement('svg', {...props, xmlns:"/vendor/svg-b0568748", fill:"none", viewBox:"0 0 24 24", strokeWidth:1.5, stroke:"currentColor"}, React.createElement('path', {strokeLinecap:'round', strokeLinejoin:'round', d:"M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"}))
    ),
    ...
    Bars3Icon: (props) => (
      React.createElement('svg', {...props, xmlns:"/vendor/svg-b0568748", fill:"none", viewBox:"0 0 24 24", strokeWidth:1.5, stroke:"currentColor"}, React.createElement('path', {strokeLinecap:'round', strokeLinejoin:'round', d:"M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5"}))
    ),
    PaperClipIcon: (props) => (
    ...
    PaperAirplaneIcon: (props) => (
      React.createElement('svg', {...props, xmlns:"/vendor/svg-b0568748", fill:"none", viewBox:"0 0 24 24", strokeWidth:1.5, stroke:"currentColor"}, React.createElement('path', {strokeLinecap:'round', strokeLinejoin:'round', d:"M6 12 3.269 3.125A59.769 59.769 0 0 1 21.485 12 59.768 59.768 0 0 1 3.27 20.875L5.999 12Zm0 0h7.5"}))
    ),
    ...
    ChatBubbleBottomCenterPlusIcon: (props) => (
      React.createElement('svg', {...props, xmlns:"/vendor/svg-b0568748", fill:"none", viewBox:"0 0 24 24", strokeWidth:1.5, stroke:"currentColor"}, React.createElement('path', {strokeLinecap:'round', strokeLinejoin:'round', d:"M12 9v6m3-3H9m12 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"}))
    ),
    ClockIcon: (props) => (
        React.createElement('svg', {...props, xmlns:"/vendor/svg-b0568748", fill:"none", viewBox:"0 0 24 24", strokeWidth:1.5, stroke:"currentColor"}, React.createElement('path', {strokeLinecap:'round', strokeLinejoin:'round', d:"M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"}))
    ),
    CpuChipIcon: (props) => (
    ...
    ArrowLeftIcon: (props) => (
      React.createElement('svg', {...props, xmlns:"/vendor/svg-b0568748", fill:"none", viewBox:"0 0 24 24", strokeWidth:1.5, stroke:"currentColor"}, React.createElement('path', {strokeLinecap:'round', strokeLinejoin:'round', d:"M10.5 19.5 3 12m0 0 7.5-7.5M3 12h18"}))
    ),
    EyeIcon: (props) => (
      React.createElement('svg', {...props, xmlns:"/vendor/svg-b0568748", fill:"none", viewBox:"0 0 24 24", strokeWidth:1.5, stroke:"currentColor"}, 
    ...
    XMarkIcon: (props) => (
      React.createElement('svg', {...props, xmlns:"/vendor/svg-b0568748", fill:"none", viewBox:"0 0 24 24", strokeWidth:1.5, stroke:"currentColor"}, React.createElement('path', {strokeLinecap:'round', strokeLinejoin:'round', d:"M6 18 18 6M6 6l12 12"}))
    ),
  };
...
export const GoogleIcon = (props) => (
  React.createElement('svg', {...props, viewBox:"0 0 24 24", xmlns:"/vendor/svg-b0568748"}, 
...
export const PerplexityIcon = (props) => (
    React.createElement('svg', {...props, viewBox:"0 0 24 24", fill:"none", xmlns:"/vendor/svg-b0568748"},
...
export const PhindIcon = (props) => (
  React.createElement('svg', {...props, xmlns:"/vendor/svg-b0568748", viewBox:"0 0 24 24", fill:"currentColor"}, React.createElement('path', {d:"M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2zm-1 15v-4H8v-2h3V7h2v4h3v2h-3v4z"}))
);
